...
const BlueBar = () => {
  ...
  return (
    <div className="flex justify-center h-[700px] mt-10 relative ml-7.9">
      {" "}
      {/* Adjusted position */}
      <div className="bg-[#E5F0F1] w-full max-w-7x1 p-6 relative rounded-lg">
        {/* Products Title */}
        ...
        <div className="absolute top-[220px] left-10 flex flex-col items-start">
          ...
          <h2 className="text-4xl font-bold font-urbanist7  ml-[6.5rem] ">
            Delhi Itinerary
          </h2>
        ...
        <div className="ml-12 relative" style={{ right: "-620px" }}>
          <Image
